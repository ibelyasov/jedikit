...
- `v0.1.0-alpha.2` удаляет только неавторизованные MCP-дубли из Hermes package; root `.mcp.json` для Codex/Claude и оба host-level Hermes OAuth connections сохраняются.
