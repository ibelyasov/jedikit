...
- Быстрый capture сохраняет исходную фразу во Inbox. Во время поштучного triage после подтверждения она заменяется канонической формулировкой; история и служебный `raw_text` не сохраняются.
