...
- v1 распознаёт идею и даёт инструкцию ручного переноса в пользовательское место; собственной структуры и task-дубликата не создаёт. Cleanup исходного item остаётся заблокирован до появления подтверждённого permanent-delete capability.
